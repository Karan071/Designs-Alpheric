...
export default function Hero() {
    return <section className="py-35 bg-[radial-gradient(ellipse_50%_100%_at_top_right,#EDE6FE_10%,#FFFFFF_100%)]">
        <div className="relative mx-[120px]">
            <div>
                <h1 className="font-instrument-sans text-[130px]/40 font-semibold">
                    Pinpointing <img className="inline-block bg-[#5AC8DC] rounded-[66px] h-[120px] w-auto object-contain align-middle" src={girl} alt="asset girl" /> your <br/> digital needs
                </h1>
            </div>
            ...
            <div className="absolute right-45 top-6">
                <img className="h-[150px]" src={alphericGif} alt="alpheric gif" />
            </div>
            {/* video player */}
            <div className="mt-5">
                <Videoplayer />
